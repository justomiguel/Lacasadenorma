 ...
 */
export function PageIndex({ locale, ui }: { locale: Locale; ui: UiContent }) {
  return (
    ...
    <Container as="nav" aria-label={ui.nav.index} className="lg:hidden">
      <ul className="border-t border-rule">
        {PRIMARY_NAV.map((item) => {
          const copy = ui.primaryNav[item.href];
