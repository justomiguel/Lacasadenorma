...
| III · Simplicidad | Cero dependencias nuevas. Sin cola de correo, sin captcha, sin OAuth, sin motor de plantillas. El único patrón agregado es el puerto `EmailSender`, y existe porque hay dos implementaciones reales el primer día (Resend y la que registra y no manda) | ✅ |
