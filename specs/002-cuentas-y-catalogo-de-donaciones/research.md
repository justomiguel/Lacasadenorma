...
| OAuth con Google | Revisitado: el pedido llegó después. La decisión está en [ADR-038](../../docs/adr/038-oauth-nativo.md). No se investigó un SDK propio: Auth ya habla OAuth |
