...
export const catalogSchema = pageSchema.extend({
  ...
  listCaption: z.string().min(1),
  categoryJumpLabel: z.string().min(1),
  columnItem: z.string().min(1),
  columnQuantity: z.string().min(1),
  columnTaken: z.string().min(1),
  columnName: z.string().min(1),
  columnUnitPrice: z.string().min(1),
  columnTotal: z.string().min(1),
  columnDonate: z.string().min(1),
  donateCta: z.string().min(1),
  donateCtaLabel: z.string().min(1),
  takenYes: z.string().min(1),
  takenNo: z.string().min(1),
  nameNone: z.string().min(1),
  namedShare: z.string().min(1),
  namedQuantity: z.string().min(1),
  donorsLabel: z.string().min(1),
  quantityOf: z.string().min(1),
  remainingFact: z.string().min(1),
  remainingOf: z.string().min(1),
  estimatedUnit: z.string().min(1),
  backToList: z.string().min(1),
  coverTitle: z.string().min(1),
  coverLead: z.string().min(1),
  coverNoEstimate: z.string().min(1),
  coverUnit: z.string().min(1),
  coverNet: z.string().min(1),
  coverMercadoPago: z.string().min(1),
  coverExtra: z.string().min(1),
  coverExtraHint: z.string().min(1),
  coverTotal: z.string().min(1),
  coverPaypal: z.string().min(1),
  coverClaim: z.string().min(1),
  coverClaiming: z.string().min(1),
  coverTransferChannel: z.string().min(1),
  coverMercadoPagoChannel: z.string().min(1),
  coverPaypalChannel: z.string().min(1),
  coverBringChannel: z.string().min(1),
  coverMoneyPath: z.string().min(1),
