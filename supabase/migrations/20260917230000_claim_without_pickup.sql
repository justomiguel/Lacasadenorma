-- Con sesión, traer un bien no pide nombre ni dirección: la cuenta ya
-- identifica (ADR-051, FR-216, FR-265). Los argumentos siguen opcionales
-- para reservas viejas y para pg_temp.traer en las pruebas.
...
comment on function public.claim_donation_item(
  ...
  'Única vía para crear una reserva con cuenta. pending y approved reservan; declined no. Con sesión no pide datos de retiro: la cuenta identifica (ADR-051).';
